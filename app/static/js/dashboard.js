(function () {
  ...
  var overlay    = document.getElementById('seed-modal-overlay');
  var triggerBtn = document.getElementById('seed-picker-btn');
  var closeBtn   = document.getElementById('seed-modal-close');
  var hiddenInput = document.getElementById('seed-date-value');
  if (!container || !overlay || !triggerBtn || !hiddenInput) return;
  ...
  function openModal()  { overlay.classList.add('cal-overlay-open'); overlay.setAttribute('aria-hidden', 'false'); }
  function closeModal() { overlay.classList.remove('cal-overlay-open'); overlay.setAttribute('aria-hidden', 'true'); }

  function updateTrigger() {
    triggerBtn.textContent = selectedDate || '— normal play —';
  }
  ...
  triggerBtn.addEventListener('click', function () { render(); openModal(); });
